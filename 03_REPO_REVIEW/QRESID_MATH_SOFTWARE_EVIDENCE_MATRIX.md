...
POST_CHANGE_SYNC_DONE: math/software evidence matrix updated after hurdle RQR theory gate creation; hurdle count has closed distribution-level PIT/CDF formulas but no accepted Stata estimator route.
