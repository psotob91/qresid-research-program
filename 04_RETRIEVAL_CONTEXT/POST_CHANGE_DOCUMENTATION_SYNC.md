...
| cambio en `.sthlp`, MarkDoc, GitHub tooling o Quarto docs | help style master, documentation tooling master, package style rules, registry | `STATA_HELP_STYLE_MASTER.md`, `QRESID_DOCUMENTATION_TOOLING_MASTER.md`, website blueprint/regenerable map | si |
