...
| R-008 | R_documentation | `VGAM::genpoisson0/1/2` | local R package `VGAM` 1.1.14; CRAN refman | AVAILABLE | Package documentation; used for parameter mapping and positive-delta GP-0 CDF check | `QRESID_GENPOISSON_EXTENSION_AUDIT.md`; `QRESID_ESTIMATOR_EQUIVALENCE_AUDIT.md`; `QRESID_GENPOISSON_HURDLE_RELEASE_DECISION.md` | 2026-05-10 | `pgenpois0` matches pinned `st0279` PMF/CDF for positive delta with `theta=(1-delta)*mu`, `lambda=delta`; negative delta uses analytic CDF replay because modern VGAM restricts the fitted GP-0 lambda route. |
| R-009 | R_documentation | `glmmTMB::genpois` | local R package `glmmTMB` 1.1.14; online reference | AVAILABLE | Package documentation; secondary family evidence, not exact benchmark for `st0279` | `QRESID_GENPOISSON_EXTENSION_AUDIT.md`; `QRESID_ESTIMATOR_EQUIVALENCE_AUDIT.md`; `QRESID_GENPOISSON_HURDLE_RELEASE_DECISION.md` | 2026-05-10 | glmmTMB generalized Poisson uses a different variance parameterization; retained for future approximate/simulation work. |
| R-010 | R_documentation | `pscl::hurdle` | https://search.r-project.org/CRAN/refmans/pscl/html/hurdle.html | AVAILABLE_EXTERNAL_NOT_INSTALLED | Package documentation; local package not installed at gate creation | `QRESID_HURDLE_RQR_THEORY_AND_BENCHMARK.md`; `QRESID_ESTIMATOR_EQUIVALENCE_AUDIT.md`; `QRESID_GENPOISSON_HURDLE_RELEASE_DECISION.md` | 2026-05-10 | Candidate estimator benchmark for Poisson/NB hurdle count models if installed or otherwise authorized. |
| R-011 | R_documentation | `glmmTMB` hurdle count routes | local R package `glmmTMB` 1.1.14; https://glmmtmb.github.io/glmmTMB/reference/glmmTMB.html | AVAILABLE | Package documentation; possible zero component plus truncated count family estimator | `QRESID_HURDLE_RQR_THEORY_AND_BENCHMARK.md`; `QRESID_ESTIMATOR_EQUIVALENCE_AUDIT.md`; `QRESID_GENPOISSON_HURDLE_RELEASE_DECISION.md` | 2026-05-10 | Candidate R estimator and DHARMa simulation sanity route for non-correlated hurdle count models. |
| R-012 | R_documentation | `VGAM` zero-altered and positive-count families | local R package `VGAM` 1.1.14; https://www.rdocumentation.org/packages/VGAM/versions/1.1-14/topics/zanegbinomial | AVAILABLE | Package documentation; CDF/PIT replay candidate | `QRESID_HURDLE_RQR_THEORY_AND_BENCHMARK.md`; `QRESID_ESTIMATOR_EQUIVALENCE_AUDIT.md`; `QRESID_GENPOISSON_HURDLE_RELEASE_DECISION.md` | 2026-05-10 | Candidate CDF/distribution support for zero-altered and positive Poisson/NB hurdle layers. |
| R-013 | R_documentation | `topmodels::qresiduals` | https://rdrr.io/rforge/topmodels/man/qresiduals.html | AVAILABLE_EXTERNAL_NOT_INSTALLED | Package documentation; local package not installed at gate creation | `QRESID_HURDLE_RQR_THEORY_AND_BENCHMARK.md`; `QRESID_ESTIMATOR_EQUIVALENCE_AUDIT.md`; `QRESID_GENPOISSON_HURDLE_RELEASE_DECISION.md` | 2026-05-10 | Documents PIT/RQR interpretation for probabilistic model residuals; not required for qresid endpoint replay. |
...
| STATA-EXT-003 | SSC_RePEc_software | `hplogit` Poisson-logit hurdle regression | `04_RETRIEVAL_CONTEXT/EXTERNAL_REPOS/STATA/hurdle_count_hilbe_hardin`; RePEc https://econpapers.repec.org/RePEc%3Aboc%3Abocode%3As456405 | AVAILABLE_PINNED | GPL v3 per RePEc; external dependency only, do not copy into `qresid` package payload | `QRESID_HURDLE_STATA_ADO_PINNING_AUDIT.md`, `QRESID_HURDLE_COUNT_POSTESTIMATION_EXTRACTION_AUDIT.md`, `QRESID_HURDLE_COUNT_BENCHMARK_MATRIX.md` | 2026-05-10 | Pinned `hplogit.ado` version 1.0.0, `jhpoi_logit_ll.ado`, and `hplogit.hlp`; benchmark gate passed against `pscl::hurdle` after zero-equation sign adjustment. |
| STATA-EXT-004 | SSC_RePEc_software | `hnblogit` negative-binomial-logit hurdle regression | `04_RETRIEVAL_CONTEXT/EXTERNAL_REPOS/STATA/hurdle_count_hilbe_hardin`; RePEc https://ideas.repec.org/c/boc/bocode/s456401.html | AVAILABLE_PINNED | GPL v3 per RePEc; external dependency only, do not copy into `qresid` package payload | `QRESID_HURDLE_STATA_ADO_PINNING_AUDIT.md`, `QRESID_HURDLE_COUNT_POSTESTIMATION_EXTRACTION_AUDIT.md`, `QRESID_HURDLE_COUNT_BENCHMARK_MATRIX.md` | 2026-05-10 | Pinned `hnblogit.ado` version 1.0.0, `jhnb_logit_ll.ado`, and `hnblogit.hlp`; benchmark gate passed against `pscl::hurdle` after zero-equation sign adjustment. |
| STATA-EXT-005 | GitHub_Stata_tooling | Haghish `github` Stata package manager/build helper | `04_RETRIEVAL_CONTEXT/EXTERNAL_REPOS/STATA/haghish/github`; https://github.com/haghish/github | AVAILABLE_PINNED | MIT per `github.pkg` and `make.do`; documentation tooling only | `QRESID_DOCUMENTATION_TOOLING_MASTER.md` | 2026-05-10 | Pinned commit `85e5f9aa9dfa5dc656be44f25a9bb0e71717db5b`; not a `qresid` runtime dependency. |
| STATA-EXT-006 | GitHub_Stata_tooling | Haghish `markdoc` literate/documentation package | `04_RETRIEVAL_CONTEXT/EXTERNAL_REPOS/STATA/haghish/markdoc`; https://github.com/haghish/markdoc | AVAILABLE_PINNED | MIT per `markdoc.pkg`, `make.do`, and source headers; documentation tooling only | `QRESID_DOCUMENTATION_TOOLING_MASTER.md`, `STATA_HELP_STYLE_MASTER.md` | 2026-05-10 | Pinned commit `d949731ac730a66252a45d3a106500c8f3178225`; may prototype SMCL/help generation but is not a runtime dependency. |
| R-EXT-006 | Web_style_reference | `ggeffects` pkgdown website/source style reference | `04_RETRIEVAL_CONTEXT/EXTERNAL_REPOS/R/ggeffects`; https://github.com/strengejacke/ggeffects | AVAILABLE_PINNED | MIT per repository license; style/reference only | `QRESID_GGEFFECTS_WEB_STYLE_MASTER.md`, `QRESID_QUARTO_WEBSITE_BLUEPRINT.md` | 2026-05-10 | Pinned commit `fa3a1ffb991c0e98601d36ecaaca73b6bfcfe16d`; do not copy content verbatim or treat as qresid dependency. |
| R-PKG-ADJ-001 | Residual_formula_audit | `glmtoolbox::residuals2` | local R library; CRAN package `glmtoolbox` | AVAILABLE_INSTALLED | GPL-3 per package metadata; formula/source audit and benchmark only | `QRESID_STANDARDIZED_QUANTILE_RESIDUALS_GATE.md` | 2026-05-10 | Version 0.1.12. Source shows `type=\"quantile\"` and `standardized=TRUE` divides quantile residuals by `sqrt(1-h)`. |
| R-PKG-ADJ-002 | Residual_formula_audit | `gamlss` residual z-scores/RQR helpers | local R library; CRAN package `gamlss` | AVAILABLE_INSTALLED | GPL per package metadata; formula/source audit only | `QRESID_STANDARDIZED_QUANTILE_RESIDUALS_GATE.md` | 2026-05-10 | Version 5.5-0. Confirms z-score/RQR taxonomy but not a qresid adjusted/studentized formula. |
| R-PKG-ADJ-003 | Residual_formula_audit | `topmodels::proresiduals` | local R library; R-Forge package `topmodels` | AVAILABLE_INSTALLED | GPL per package metadata; formula/source audit only | `QRESID_STANDARDIZED_QUANTILE_RESIDUALS_GATE.md` | 2026-05-10 | Version 0.3-0 from R-Forge. Confirms PIT/probabilistic residual logic, not leverage adjustment. |
| PAPER-ADJ-001 | Residual_formula_audit | `Scudilio and Pereira adjusted quantile residual` | `04_RETRIEVAL_CONTEXT/EXTERNAL_REPOS/PAPERS/scudilio_pereira_adjusted_quantile_residual/` and https://arxiv.org/abs/1710.11172 | AVAILABLE_PINNED | arXiv source/PDF for formula audit; publisher DOI 10.1007/s00180-019-00896-w | `QRESID_ADJUSTED_STUDENTIZED_RESIDUALS_MASTER.md`; `QRESID_STANDARDIZED_QUANTILE_RESIDUALS_GATE.md` | 2026-05-11 | Source TeX confirms adjusted quantile residual `r_i^{*qu}=r_i^{qu}/sqrt(1-h_ii)` for continuous Gamma/inverse Gaussian GLM focus. |
